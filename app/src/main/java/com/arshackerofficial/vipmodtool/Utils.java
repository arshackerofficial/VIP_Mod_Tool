...
public class Utils{
    ...
    //Downloading and Unzipping Handler/Constructors
    ...
    //Custom Alertbox with Tittle and Text
    @SuppressLint("NewApi")
    public void customAlert(Context context,String msgString){
        ...
        alertDialog2.setView(title);

        alertDialog2.setPositiveButton("OK",(dialog, which) -> dialog.cancel());
        alertDialog2.show();
    ...
    //Async Tasks For Downloading And Unzipping
    private class DownloadMapAsync extends AsyncTask<String, String, String> {
        Context context;
        String string,result,zipFile,unzipLocation = "";
        ...
        protected void onPreExecute() {
            ...
            progressDialog.setMessage("Downloading Mod File..");
        ...
        protected String doInBackground(String... aurl) {
            ...
            try {
                ...
                if (http.getResponseCode()==200) {
                    ...
                    OutputStream output = context.getApplicationContext().getContentResolver().openOutputStream(Uri.fromFile(new File(zipFile)));
    ...
    private class UnZipTask extends AsyncTask<String, Void, Boolean> {
        ...
        protected Boolean doInBackground(String... params)
        {
            ...
            try {
                ...
                UnzipUtil d = new UnzipUtil(zipFile,params[0], context.getContentResolver());
                d.unzip();
        ...
        protected void onPostExecute(Boolean result)
        {
            ...
            file.delete();
            customAlert(context,"Applied Successfully");
        }
